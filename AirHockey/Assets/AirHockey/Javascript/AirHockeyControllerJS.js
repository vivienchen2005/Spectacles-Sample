...
function refreshUI() {
    ...
    startGameButtonObj.enabled = isConnected && isHost() && !isGameStartedProp.currentOrPendingValue && puck.syncEntity.doIOwnStore(); 
}
...
function onSessionReady() {
    startGameButton = startGameButtonObj.getComponent(SIK.InteractionConfiguration.requireType("PinchButton"));

    leftPaddleInteractable = leftPaddle.getSceneObject().getComponent(SIK.InteractionConfiguration.requireType("Interactable"));
    rightPaddleInteractable = rightPaddle.getSceneObject().getComponent(SIK.InteractionConfiguration.requireType("Interactable"));

    leftPaddleManipulation = leftPaddle.getSceneObject().getComponent(SIK.InteractionConfiguration.requireType("InteractableManipulation"));
    rightPaddleManipulation = rightPaddle.getSceneObject().getComponent(SIK.InteractionConfiguration.requireType("InteractableManipulation"));
